...
- To bootstrap results by species, run [bootstrap_by_spp.R](./scripts/02_run_analyses/bootstrap_by_spp.R) in the [02_run_analyses](./scripts/02_run_analyses) subfolder in the [scripts](./scripts) folder. See [bootstrap_by_spp_linear_conf.R](./scripts/02_run_analyses/bootstrap_by_spp_linear_conf.R) in the same folder to bootstrap using personal confidence weights. 
- To bootstrap results and average across all species, run [bootstrap_spp_avg.R](./scripts/02_run_analyses/bootstrap_spp_avg.R) in the [02_run_analyses](./scripts/02_run_analyses) subfolder in the [scripts](./scripts) folder. See [bootstrap_spp_avg_linear_conf.R](./scripts/02_run_analyses/bootstrap_spp_avg_linear_conf.R) in the same folder to bootstrap using personal confidence weights. 
